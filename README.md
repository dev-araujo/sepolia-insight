...
Plataforma de auditoria de **contratos inteligentes** com **IA**. Analise qualquer contrato verificado na Etherscan, receba um relatório de segurança gerado por **Llama 3** via **Groq** e salve o resultado permanentemente na **Sepolia Testnet** se quiser  👀.
